...
public class CountDown {
     ...
     * @return CountDownTimerUtils
     */
    public CountDown setCountDownInterval(long pCountDownInterval) {
     ...
     * @return CountDownTimerUtils
     */
    public CountDown setFinishDelegate(FinishDelegate pFinishDelegate) {
     ...
     * @return CountDownTimerUtils
     */
    public CountDown setMillisInFuture(long pMillisInFuture) {
     ...
     * @return CountDownTimerUtils
     */
    public CountDown setTickDelegate(TickDelegate pTickDelegate) {
